 ...
 * @author dinhd
 */
@WebServlet(name = "addNewByProduct", urlPatterns = {"/addNewByProduct"})
public class addNewByProduct extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int pid2= -1;
        try {
            pid2 = Integer.parseInt(request.getParameter("pid2"));
            if (pid2 == -1) {
...
//            System.out.println("type===========" + type);
            ...
            d.addNewForProduct(title, url, urlTextFile, 3, a.getId(), pid2);
        } catch (Exception e) {
            e.printStackTrace();
        } 
            response.sendRedirect("newsControl");
