 ...
 * @author dinhd
 */
@WebServlet(name = "makeNewsToProduct", urlPatterns = {"/makeNewsToProduct"})
public class makeNewsToProduct extends HttpServlet {
...
//         request.setCharacterEncoding("UTF-8");
        try (PrintWriter out = response.getWriter()) {
           ...
           d.insertProductByNews(id, pname, amount, price);
