 ...
 * @author dinhd
 */
@WebFilter(filterName = "SessionTimoutFilter", urlPatterns = {"/*"})
public class SessionTimoutFilter implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if (debug) {
            log("SessionTimoutFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("SessionTimoutFilter:DoAfterProcessing");
        }
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("SessionTimoutFilter:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("SessionTimoutFilter()");
        }
        StringBuffer sb = new StringBuffer("SessionTimoutFilter(");
